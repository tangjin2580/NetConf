...
SUNFLOWER_PATHS = [
    ...
    r"%PROGRAMFILES%\Oray\SunLogin\SunloginClient\AweSun.exe",
    r"%PROGRAMFILES(X86)%\Oray\SunLogin\SunloginClient\AweSun.exe",
    r"%PROGRAMFILES%\Oray\SunLogin\SunloginClient\SunloginClient.exe",
    r"%PROGRAMFILES(X86)%\Oray\SunLogin\SunloginClient\SunloginClient.exe",
    r"%PROGRAMFILES%\Oray\SunLogin\AweSun.exe",
    r"%PROGRAMFILES(X86)%\Oray\SunLogin\AweSun.exe",
    r"%PROGRAMFILES%\Oray\SunLogin\SunloginClient\sunlogin.exe",
    r"%PROGRAMFILES(X86)%\Oray\SunLogin\SunloginClient\sunlogin.exe",
    r"%USERPROFILE%\AppData\Local\Oray\SunLogin\SunloginClient\AweSun.exe",
    r"%USERPROFILE%\AppData\Local\Oray\SunLogin\AweSun.exe",
    r"%USERPROFILE%\AppData\Roaming\Oray\SunLogin\AweSun.exe",
    r"%LOCALAPPDATA%\Oray\SunLogin\SunloginClient\AweSun.exe",
    r"%LOCALAPPDATA%\Oray\SunLogin\AweSun.exe",
    r"E:\Program Files\Oray\SunLogin\SunloginClient.exe",
    r"E:\Program Files (x86)\Oray\SunLogin\SunloginClient.exe",
    r"E:\Program Files\Oray\SunLogin\AweSun.exe",
    r"E:\Program Files (x86)\Oray\SunLogin\AweSun.exe",
    r"E:\Program Files\Oray\SunLogin\SunloginClient\sunlogin.exe",
    r"E:\Program Files (x86)\Oray\SunLogin\SunloginClient\sunlogin.exe",
]
